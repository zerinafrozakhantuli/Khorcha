...
$allIncome=App\Models\Income::select(DB::raw('count(*) as total'),DB::raw('YEAR(income_date) year,MONTH(income_date) month'))->groupBy('year','month')->orderBy('income_date','DESC')->get();
...
@endphp
 ...
 <a href="{{url('dashboard/expense')}}" class="btn btn-sm btn-dark"><i class="fas fa-th"></i> Expense </a>
  ...
  <li><a class="dropdown-item" href="{{url('/dashboard/archive/'.$month_year)}}">Detailes</a></li>
