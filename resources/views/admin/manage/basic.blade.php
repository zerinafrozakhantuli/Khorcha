...
<div class="col-sm-7">
  <input type="text" class="form-control form_control" id="" name="company" value="{{$Basic->basic_company}}">
...
<div class="col-sm-7">
  <input type="text" class="form-control form_control" id="" name="title" value="{{$Basic->basic_title}}">
</div>
</div>
...
<div class="col-md-2">
   ...
   @if($Basic->basic_logo!='')
  <img height="100" src="{{asset('uploads/basic'.$Basic->basic_logo)}}" alt="logo">
  @else
  <img height="100" src="{{asset('contents/admin')}}/images/avatar.png" alt="logo">
  @endif
...
<div class="col-md-2">
  ...
  <img height="100" src="{{asset('uploads/basic'.$Basic->basic_favicon)}}" alt="favicon">
  @else
  <img height="100" src="{{asset('contents/admin')}}/images/avatar.png" alt="favicon">
  @endif
...
<div class="col-md-2">
  ...
  <img height="100" src="{{asset('uploads/basic'.$Basic->basic_flogo)}}" alt="Flogo">
  @else
  <img height="100" src="{{asset('contents/admin')}}/images/avatar.png" alt="flogo">
  @endif
