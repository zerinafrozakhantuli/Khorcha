...
<div class="row">
  <div class="col-md-8 card_title_part">
      <i class="fab fa-gg-circle"></i> User 
  </div>  
...
<div class="col-sm-7">
  ...
  <input type="hidden" name="slug" value="{{$all->slug}}"/>
  <input type="text" class="form-control form_control" id="" name="name" value="{{$all->name}}">
    @if($errors->has('name'))
...
<div class="col-sm-7">
  <input type="email" class="form-control form_control" id="" name="email" value="{{$all->email}}">
       @if($errors->has('email'))
    <span class="invalid-feedback" role="alert">
...
<div class="col-sm-7">
<input type="text" class="form-control form_control" id="" name="username" value="{{$all->username}}" disabled>
...
<div class="col-sm-4">
  ...
  <option value="{{$urole->role_id}}"@if($urole->role_id==$all->role) SELECTED @endif>{{$urole->role_name}}</option>
   @endforeach
  </select>
       @if($errors->has('role'))
    <span class="invalid-feedback" role="alert">
...
<div class="col-md-2">
   ...
   @if($all->photo!='')
  <img height="100" src="{{asset('uploads/users/'.$all->photo)}}" alt="User Photo">
  @else
  <img height="100" src="{{asset('contents/admin')}}/images/avatar.png" alt="User Photo">
  @endif
