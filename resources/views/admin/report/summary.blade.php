        ...
        <div class="row">
          ...
          <div class="col-md-8 mb-3">
            <form method="get" action="{{url('dashboard/report/search')}}">
              <div class="row">
                <div class="col-md-5">
              <input type="text" class="form-control" id="startDate" name="starting" value="{{old('starting')}}"  placeholder="Form">
                </div>
                <div class="col-md-5 pad_left_0">
            <input type="text" class="form-control" id="endDate" name="ending" value="{{old('ending')}}" placeholder="To">
                </div>
